    ...
    <section id="about" className="mt-12 border-t pt-20 -mt-20">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        <div className="bg-white rounded-xl p-4 shadow">
          ...
          <div className="mt-1 text-gray-700">Data Structures and Algorithms, Mathematics, Statistics, Web Development, Software Engineering, AI, Teaching.</div>
        </div>
        <div className="bg-white rounded-xl p-4 shadow">
          <div className="text-sm text-gray-500">Fun</div>
          <div className="mt-1 text-gray-700">Playing games (Mobile and PC Games), Cooking, Watching Movie and Anime, Reading Comic, Sleeping.</div>
        </div>
      </div>
    </section>
  )
