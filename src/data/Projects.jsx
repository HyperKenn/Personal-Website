...
const sampleProjects = [
    {
        ...
        title: 'InsightUBC',
        category: 'Personal',
        short: 'A web application that allows user to add, delete, and query datasets containing valid UBC courses information',
        ...
        tech: ['Javascript', 'TypeScript', 'Node.js', 'Express', 'RESTAPI', 'Mocha/Chai', 'Selenium', 'Git', 'Github', 'HTML', 'TailwindCSS', 'Vite'],
        demo: null,
        github: null,
    },
    {
    ...
    },
    {
        ...
        details: ['Implemented progress tracking and WPM (Words Per Minute) tracking system, displaying users’ typing speed and current typing position in the TypeRacer game.',
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div className="bg-white rounded-xl p-6 z-10 w-full max-w-xl shadow-lg max-h-[85vh] overflow-y-auto">
          ...
          <div className="mt-6 flex gap-3 flex-wrap">
            {/* Demo: if demo link exists show it, else show "Demo Coming Soon" */}
            {project.demo ? (
              <a
                href={project.demo}
                target="_blank"
            ...
            {/* GitHub: you said you will handle it later; keep placeholder behavior */}
            {project.github ? (
              <a
                href={project.github}
                target="_blank"
